...
function playMusic(id)
{
	if(id=="song1")
	{
		pausing("song1");
		imaging(".song1");
		setTimeout(function(){song1.pause();document.querySelector(".song1").setAttribute("src","play.png");},5000);
	}
	else if(id=="song2")
	{
		pausing("song2");
		imaging(".song2");
		setTimeout(function(){song2.pause();document.querySelector(".song2").setAttribute("src","play.png");},5000);
	}
	else if(id=="song3")
	{
		pausing("song3");
		imaging(".song3");
		setTimeout(function(){song3.pause();document.querySelector(".song3").setAttribute("src","play.png");},5000);
	}
	else if(id=="song4")
	{
		pausing("song4");
		imaging(".song4");
		setTimeout(function(){song4.pause();document.querySelector(".song4").setAttribute("src","play.png");},5000);
	}
	else if(id=="song5")
	{
		pausing("song5");
		imaging(".song5");
		setTimeout(function(){song5.pause();document.querySelector(".song5").setAttribute("src","play.png");},5000);
	}
	else if(id=="song6")
	{
		pausing("song6");
		imaging(".song6");
		setTimeout(function(){song6.pause();document.querySelector(".song6").setAttribute("src","play.png");},5000);
	}
	else if(id=="song7")
	{
		pausing("song7");
		imaging(".song7");
		setTimeout(function(){song7.pause();document.querySelector(".song7").setAttribute("src","play.png");},5000);
	}
	else if(id=="song8")
	{
		pausing("song8");
		imaging(".song8");
		setTimeout(function(){song8.pause();document.querySelector(".song8").setAttribute("src","play.png");},5000);
	}
	else if(id=="song9")
	{
		pausing("song9");
		imaging(".song9");
		setTimeout(function(){song9.pause();document.querySelector(".song9").setAttribute("src","play.png");},5000);
	}
	else if(id=="song10")
	{
		pausing("song10");
		imaging(".song10");
		setTimeout(function(){song10.pause();document.querySelector(".song10").setAttribute("src","play.png");},5000);
	}
}
